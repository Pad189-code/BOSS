        ...
        {offreSelectionnee ? (
            ...
            <div className="flex shrink-0 items-center justify-between border-b border-gray-200 bg-white px-6 py-3">
              <div>
                ...
                <p className="text-sm text-gray-500">
                  De :{" "}
                  <span className="font-medium">{offreSelectionnee.expediteur_nom}</span> ·{" "}
            ...
            <div className="flex min-h-0 flex-1">
              ...
              <div className="min-w-0 flex-1 space-y-4 overflow-y-auto p-5">
                ...
                <div className="overflow-hidden rounded-xl border border-gray-200 bg-white">
                                ...
                                <div className="h-1.5 w-12 overflow-hidden rounded-full bg-gray-200">
                                  <div
                                    className={`h-full rounded-full ${
                                      ligne.score_similarite > 0.85
                                        ? "bg-green-500"
                                        : ligne.score_similarite > 0.7
                                          ? "bg-amber-400"
                                          : "bg-red-400"
                                    }`}
                                    style={{
                                      width: `${ligne.score_similarite * 100}%`,
                                    }}
                                  />
                                </div>
                                <span className="text-gray-400">
                                  {Math.round(ligne.score_similarite * 100)}%
                                </span>
                              </div>
                            </td>
                            <td className="px-3 py-2">
                              <button
                                ...
                                className="text-base leading-none text-red-400 transition hover:text-red-600"
                  ...
                  <div className="space-y-1 border-t border-gray-200 bg-gray-50 px-4 py-3">
                    <div className="flex justify-end gap-8 text-xs text-gray-500">
                    ...
                    <div className="flex justify-end gap-8 text-sm font-bold text-[#1A3A5C]">
                      <span>TOTAL TTC</span>
                      <span className="w-28 text-right">
          ...
          <div className="flex flex-1 items-center justify-center text-gray-400">
            <div className="space-y-2 text-center">
              <p className="text-lg font-medium">Sélectionnez une offre</p>
              <p className="text-sm">Choisissez une demande dans la liste de gauche</p>
            </div>
          </div>
        )}
      </div>
