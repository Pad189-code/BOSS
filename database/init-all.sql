...
-- Inclut : schema.sql + migration 001 + migration 002
--
-- Usage :
--   psql $DATABASE_URL < database/init-all.sql
...
-- ---------------------------------------------------------------------------
-- Types ENUM (ignorés si déjà présents)
-- ---------------------------------------------------------------------------
DO $$ BEGIN
...
-- Migration 002 : index unique pour éviter les doublons à la synchronisation IMAP
...
-- Triggers (DROP IF EXISTS + CREATE pour idempotence)
